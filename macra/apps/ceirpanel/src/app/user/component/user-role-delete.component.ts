...
@Component({
  selector: 'ceirpanel-user-role-delete',
  template: `
...
export class UserRoleDeleteComponent{
    ...
    @Input() open = false;
    userGroup!: UserRoleDto;
    userGroups: Array<any> = [];
    @Output() public confirmation: EventEmitter<UserRoleDto | Array<UserRoleDto>> = new EventEmitter();
    @Output() public aconfirmation: EventEmitter<UserRoleDto | Array<UserRoleDto>> = new EventEmitter();
    readonly = true;
