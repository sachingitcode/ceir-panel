...
public class TicketService {
	...
	public TicketResponseDto save(TicketDto ticketDto) {
		...
		try {
			...
			ticketResponse = redmineRemoteRepository.createTicket(ticketDto, ticketHelper.toRedmineHeaderForTicketCreate(ticketDto));
	...
	public ApiStatusDto sendotp(String msisdn) {
		try {
			...
			NotificationDto request = NotificationDto.builder().channelType(otpChannelType)
